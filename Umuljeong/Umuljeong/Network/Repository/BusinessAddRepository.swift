...
class BusinessAddRepository {
    ...
    func requestBusinessAdd(businessInfo: BusinessInfo, completion: @escaping (Result<Bool, NetworkError<Bool>>) -> Void) {
        let url = URLConstants.Business_Add(clientId: "1") //통신할 API 주소
