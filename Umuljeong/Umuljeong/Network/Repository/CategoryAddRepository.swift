...
class CategoryAddRepository {
    ...
    func requestCategoryAdd(categoryInfo: CategoryInfo, completion: @escaping (Result<Bool, NetworkError<Bool>>) -> Void) {
        let url = URLConstants.TaskCategory_Add(companyId: "1") //통신할 API 주소
