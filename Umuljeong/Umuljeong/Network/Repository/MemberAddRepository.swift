...
class MemberAddRepository {
    ...
    func requestMemberAdd(memberInfo: MemberInfo, completion: @escaping (Result<Bool, NetworkError<Bool>>) -> Void) {
        let url = URLConstants.Member_Add(companyId: "1") //통신할 API 주소
