...
class MemberFixRepository {

    //정보 다는 필요 없는데 통째로 안 받아 오는 게 낫나?
    func requestMemberFix(memberInfo: MemberInfo, completion: @escaping (Result<Bool, NetworkError<Bool>>) -> Void) {
        let url = URLConstants.Member_Fix
