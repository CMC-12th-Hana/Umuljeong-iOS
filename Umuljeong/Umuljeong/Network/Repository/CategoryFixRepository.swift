...
class CategoryFixRepository {
    ...
    func requestCategoryFix(categoryInfo: CategoryInfo, completion: @escaping (Result<Bool, NetworkError<Bool>>) -> Void) {
        let url = URLConstants.TaskCategory_Fix(categoryId: "3") //통신할 API 주소
