...
struct FixLeaderMyProfileView: View {
...
struct FixMemberView_Previews: PreviewProvider {
    static var previews: some View {
        FixLeaderMyProfileView(userInfo: UserInfoResponse(companyId: 0, memberId: 0, name: "", role: "", companyName: "", staffRank: "", phoneNumber: "", staffNumber: ""))
    }
}
